...
namespace ChangeFeedFunctions
{
    ...
    {
        private static readonly string _endpointUri = "https://cosmoslab82658.documents.azure.com:443/";
        private static CosmosClient _client = new CosmosClient(
            _endpointUri, 
            new DefaultAzureCredential(new DefaultAzureCredentialOptions 
            { 
                TenantId = "1cef4996-93f1-4f29-b346-6abce2440ff6" 
            }));
